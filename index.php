		...
		<table class="list pad fixed">
			...
			foreach($timesort as $t) {
				...
				<tr>
					...
					<td>
						<a href="preview.php?node=<?php echo $m['id'] ?>&queueid=<?php echo $m['data']->id ?>"><?php p($m['data']->msgsubject) ?></a>
					</td>
					<td>
					...
					<td>
						<a title="Preview" class="icon mail" href="preview.php?node=<?php echo $m['id'] ?>&queueid=<?php echo $m['data']->id ?>"></a>
