	...
	<div class="panel panel-default">
		...
		<div class="panel-body">
			...
			{if $show_script == "bwlist"}
				...
				<div class="hslheader">Data context</div>
				<pre class="hslbody">{include file='scripts/hsl_bwlist.tpl'}</pre>
				...
				<div class="hslheader">Data context</div>
				<pre class="hslbody">{include file='scripts/hsl_bwlist_peruser.tpl'}</pre>
			{else if $show_script == "spam"}
				...
				<div class="hslheader">Data context</div>
				<pre class="hslbody">{include file='scripts/hsl_spam.tpl'}</pre>
			{else if $show_script == "datastore"}
				...
				<div class="hslheader">Data context</div>
				<pre class="hslbody">{include file='scripts/hsl_datastore.tpl'}</pre>
			{else if $show_script == "history"}
				...
				<div class="hslheader">Data context</div>
				<pre class="hslbody">{include file='scripts/hsl_logging.tpl'}</pre>
				...
				<div class="hslheader">Post-delivery context</div>
				<pre class="hslbody">{include file='scripts/hsl_loggingpost.tpl'}</pre>
			...
			{else if $show_script == "usercreation"}
				...
				<div class="hslheader">Data context</div>
				<pre class="hslbody">{include file='scripts/hsl_usercreation.tpl'}</pre>
			{else}
				...
				<div class="hslheader">API context</div>
				<pre class="hslbody">{$hsl_script}</pre>
			{/if}
		</div>
	</div>
</div>
